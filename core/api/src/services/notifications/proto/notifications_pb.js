...
proto.services.notifications.v1.MsgMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.services.notifications.v1.MsgMessageStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
...
/**
 * optional MsgMessageStatus status = 3;
 * @return {!proto.services.notifications.v1.MsgMessageStatus}
 */
proto.services.notifications.v1.MsgMessage.prototype.getStatus = function() {
  return /** @type {!proto.services.notifications.v1.MsgMessageStatus} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.services.notifications.v1.MsgMessageStatus} value
 * @return {!proto.services.notifications.v1.MsgMessage} returns this
 */
