...
goog.exportSymbol('proto.services.notifications.v1.BulletinButton', null, global);
 ...
 * @constructor
 */
proto.services.notifications.v1.BulletinButton = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.notifications.v1.BulletinButton, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.notifications.v1.BulletinButton.displayName = 'proto.services.notifications.v1.BulletinButton';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
bulletinButton: (f = msg.getBulletinButton()) && proto.services.notifications.v1.BulletinButton.toObject(includeInstance, f)
  };
...
proto.services.notifications.v1.MarketingNotificationTriggered.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.services.notifications.v1.BulletinButton;
      reader.readMessage(value,proto.services.notifications.v1.BulletinButton.deserializeBinaryFromReader);
      msg.setBulletinButton(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.services.notifications.v1.MarketingNotificationTriggered.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBulletinButton();
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.services.notifications.v1.BulletinButton.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional BulletinButton bulletin_button = 8;
 * @return {?proto.services.notifications.v1.BulletinButton}
 */
proto.services.notifications.v1.MarketingNotificationTriggered.prototype.getBulletinButton = function() {
  return /** @type{?proto.services.notifications.v1.BulletinButton} */ (
    jspb.Message.getWrapperField(this, proto.services.notifications.v1.BulletinButton, 8));
};


/**
 * @param {?proto.services.notifications.v1.BulletinButton|undefined} value
 * @return {!proto.services.notifications.v1.MarketingNotificationTriggered} returns this
*/
proto.services.notifications.v1.MarketingNotificationTriggered.prototype.setBulletinButton = function(value) {
 ...
 * @return {!proto.services.notifications.v1.MarketingNotificationTriggered} returns this
 */
proto.services.notifications.v1.MarketingNotificationTriggered.prototype.clearBulletinButton = function() {
  return this.setBulletinButton(undefined);
};
 ...
 * @return {boolean}
 */
proto.services.notifications.v1.MarketingNotificationTriggered.prototype.hasBulletinButton = function() {
  return jspb.Message.getField(this, 8) != null;
};
 ...
 * @return {!Object}
 */
proto.services.notifications.v1.BulletinButton.prototype.toObject = function(opt_includeInstance) {
  return proto.services.notifications.v1.BulletinButton.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.notifications.v1.BulletinButton} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.BulletinButton.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.services.notifications.v1.BulletinButton}
 */
proto.services.notifications.v1.BulletinButton.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.notifications.v1.BulletinButton;
  return proto.services.notifications.v1.BulletinButton.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.notifications.v1.BulletinButton} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.notifications.v1.BulletinButton}
 */
proto.services.notifications.v1.BulletinButton.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.notifications.v1.BulletinButton.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.notifications.v1.BulletinButton.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.notifications.v1.BulletinButton} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.BulletinButton.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getLabel();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.notifications.v1.BulletinButton.prototype.getLabel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.notifications.v1.BulletinButton} returns this
 */
proto.services.notifications.v1.BulletinButton.prototype.setLabel = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
